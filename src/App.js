...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      bgStyle: {},
      icons: Configs.icons || [],
      profilePicURL: Configs.profilePicURL || 'https://i.pinimg.com/originals/6c/ce/de/6ccede86e8a11d520f5e7a3386d46ff0.jpg'
    };
  }
  ...
  render() {
    const {
      appClass, bgStyle, backgroundMode, devIntro, devDesc, icons, profilePicURL
    } = this.state;
    ...
    return (
      <div className={ appClass } style={ bgStyle }>
        ...
        <div
          ...
          <div>
            <img className="avatar" src={ profilePicURL } alt="Avatar"/>
          </div>
